...
const Footer = () => {
  return (
    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-gray-500 dark:text-gray-300'>
            ...
            className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor dark:border-gray-700 border-b'>
                ...
                className='flex flex-wrap justify-between w-full md:w-1/2 gap-8'>
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-1.5'>
                            <li>Raj Kumar prasad</li>
                            <li>Siliguri, West Bengal</li>
                            <li>+91 7364822680</li>
                            <li>rajprasad86965@gmail.com</li>
                        </ul>
                    </div>
