...
const Newsletter = () => {
  return (
    ...
    className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 my-10 mb-40">
        ...
        className="md:text-lg text-gray-500/70 dark:text-fgray-400/70 pb-8">
        ...
        <motion.form 
            ...
            className="flex items-center justify-between max-w-2xl w-full md:h-13 h-12">
                <input
                    className="border border-gray-300 dark:border-gray-700 rounded-md h-full border-r-0 outline-none w-full rounded-r-none px-3 text-gray-500 dark:text-gray-300 dark:bg-gray-800"
                    type="text"
