...
const Banner = () => {
  ...
  return (
    ...
    className='flex flex-col md:flex-row md:items-center items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2x1 overflow-hidden'>
      ...
      src={assets.banner_car_image} alt="car" className='max-h-25 mt-10 md:mt-0 md:ml-8'/>
